...
def user(username):
    ...
    posts = pagination.items
    return render_template('user.html', title='User', user=user, posts=posts, pagination=pagination)
...
def edit(id):
    ...
    if form.validate_on_submit():
        ...
        db.session.add(post)
        db.session.commit()
        flash('The post has beeen updated.')
...
def followers(username):
    ...
    return render_template('followers.html', title='Followers of', user=user,
...
def followed_by(username):
    ...
    follows = [{'user': item.followed, 'timestamp': item.timestamp}
            for item in pagination.items]
    return render_template('followers.html', title='Followed by', user=user,
...
def moderate():
    ...
    pagination = Comment.query.order_by(Comment.timestamp.desc()).paginate(
            ...
            error_out=False)
    comments = pagination.items
    return render_template('moderate.html', title='Comment Moderation', comments=comments,
